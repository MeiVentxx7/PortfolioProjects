...
-- Q1. Which state have the highest percentage of fraudulent transactions?
...
---------------------------------------------------------------------------
 ...
 -- Is there a correlation between age and occurrence of fraud transactions?
 ...
 -- There seems to be no big difference between younger people and older people
 -- Let's create a visualization and see if I can find something.
...
-- From 2019 to 2020, total of fraud transactions decreased by only 1%.
...
-- Most fraud transactions occurred around midnight.
...
-- Not enough data to see the correlation between cities and occurrence.
